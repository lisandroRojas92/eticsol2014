...
use Eticsol\EticsolBundle\Entity\Grupo;
use Eticsol\EticsolBundle\Form\GrupoType;
...
class GrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EticsolBundle:Grupo')->findAll();

        return $this->render('EticsolBundle:Grupo:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EticsolBundle:Grupo:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EticsolBundle:Grupo')->find($id);
        ...
        return $this->render('EticsolBundle:Grupo:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EticsolBundle:Grupo:edit.html.twig', array(
            'entity'      => $entity,
