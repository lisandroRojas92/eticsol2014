...
use Eticsol\EticsolBundle\Entity\Producto;
use Eticsol\EticsolBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EticsolBundle:Producto')->findAll();

        return $this->render('EticsolBundle:Producto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EticsolBundle:Producto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('EticsolBundle:Producto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EticsolBundle:Producto:edit.html.twig', array(
            'entity'      => $entity,
