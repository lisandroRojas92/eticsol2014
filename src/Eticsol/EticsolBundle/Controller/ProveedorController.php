...
use Eticsol\EticsolBundle\Entity\Proveedor;
use Eticsol\EticsolBundle\Form\ProveedorType;
...
class ProveedorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EticsolBundle:Proveedor')->findAll();

        return $this->render('EticsolBundle:Proveedor:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EticsolBundle:Proveedor:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EticsolBundle:Proveedor')->find($id);
        ...
        return $this->render('EticsolBundle:Proveedor:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EticsolBundle:Proveedor:edit.html.twig', array(
            'entity'      => $entity,
