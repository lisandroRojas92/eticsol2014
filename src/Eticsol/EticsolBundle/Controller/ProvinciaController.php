...
use Eticsol\EticsolBundle\Form\ProvinciaType;
...
class ProvinciaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EticsolBundle:Provincia')->findAll();

        return $this->render('EticsolBundle:Provincia:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EticsolBundle:Provincia:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EticsolBundle:Provincia')->find($id);
        ...
        return $this->render('EticsolBundle:Provincia:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EticsolBundle:Provincia:edit.html.twig', array(
            'entity'      => $entity,
